    ...
    <div className="flex items-center justify-center flex-col pt-10 pb-16 px-4 sm:px-8 md:px-16 lg:px-24">
      ...
      <div className="text-left w-full py-6">
        <span>
          ...
          서비스(이하 &ldquo;서비스&rdquo;라 한다)를 이용함에 있어 사이버 몰과
        ...
        <ol className="list-decimal list-inside space-y-2">
          <li>
            ...
            정보통신설비를 이용하여 재화등을 거래할 수 образом 설정한 가상의
          ...
          <li>
            &lsquo;회원&rsquo;이라 함은 &ldquo;몰&rdquo;에 개인정보를 제공하여
            회원등록을 한 자로서, &ldquo;몰&rdquo;의 정보를 지속적으로
            제공받으며, &ldquo;몰&rdquo;이 제공하는 서비스를 계속적으로 이용할
            수 있는 자를 말합니다.
          </li>
          <li>
        ...
        <ol className="list-decimal list-inside space-y-2">
          <li>
            ...
            재화·용역을 제공하는데 최선을 다하여야 합니
          </li>
          <li>
            &ldquo;몰&rdquo;은 이용자가 안전하게 인터넷 서비스를 이용할 수
