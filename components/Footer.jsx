...
const Footer = () => {
  return (
    <div className="px-[101px] pt-[49px] pb-[113px]">
      <div className="h-[1px] w-full bg-[#f4f4f4] mt-[60px] mb-[22px]"></div>

      <div className="flex justify-between ">
        <div className="flex flex-col">
          <span className="font-bold text-sm mb-8">what happened</span>
      ...
      <div className="h-[1px] w-full bg-[#f4f4f4] mt-[60px] mb-[22px]"></div>
      <div className="flex justify-between">
        <span className="text-[#a9a9a9] font-notoSansKR text-sm max-w-[839px]">
